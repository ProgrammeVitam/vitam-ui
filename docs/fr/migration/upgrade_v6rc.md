...
Récupérer les sources de déploiement de vitamui 6.rc. Renseigner le fichier repository.yml dans environment/group_vars/all/ avec les hashs de commit
permettant d'avoir les binaires de vitamui 6.rc et également ceux de vitam 6.rc. Se reférer à la procédure de déploiement de la solution pour plus de détails.
