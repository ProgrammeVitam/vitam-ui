...
> Cette opération doit être effectuée en cas de mise à jour mineure depuis une version v7.1.2- (version 7.1.2 ou inférieure) vers une version v7.1.3+ (version 7.1.3 ou supérieure).
