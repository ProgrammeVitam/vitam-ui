...
2. [Orientations techniques](orientations/orientations_techniques.md)  
   ...
   2.7. [Continuité de service](orientations/orientations_techniques.md#continuit-de-service)
    ...
    3. [Architecture](architecture/architecture.md)  
       ...
       3.2.6. [Service collect-external](architecture/services_externes.md#service-collect-external)
       3.2.7. [Service pastis-external](architecture/services_externes.md#service-pastis-external)
       ...
       3.3.6. [Service collect-search-internal](architecture/services_internes.md#service-collect-internal)
       ...
       3.11.6. [Base collect](architecture/mdd.md#Base-collect)
