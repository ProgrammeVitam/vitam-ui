...
class ImportSchemaServiceTest {
    ...
    void setUp() {
        ...
        importSchemaService = new ImportSchemaService(adminExternalClient);
    ...
    void importSchema_ShouldThrowAccessExternalClientException_OnError() throws Exception {
        ...
        assertThrows(
            ...
            () -> importSchemaService.importUnitSchema(vitamContext, schemaModels)
        );
    }
    ...
    void serializeImportSchema_ShouldNotThrowException() {
        ...
        // Act & Assert
        assertDoesNotThrow(() -> importSchemaService.serializeImportSchema(schemaModels));
    }
    ...
    void importSchema_ShouldThrowExceptionForInvalidSchema() throws Exception {
        ...
        assertThrows(
            AccessExternalClientException.class,
            () -> importSchemaService.importUnitSchema(vitamContext, invalidSchemaList)
        );
    }
    ...
    void serializeImportSchema_ShouldHandleNullSchemaList() throws IOException {
        ...
        // Act
        ByteArrayInputStream result = importSchemaService.serializeImportSchema(nullSchemaList);
    ...
    void serializeImportSchema_ShouldHandleEmptySchemaList() throws IOException {
        ...
        // Act
        ByteArrayInputStream result = importSchemaService.serializeImportSchema(emptySchemaList);
    ...
    void testSerializeImportSchema_shouldGenerateValidJson() throws IOException {
        ...
        ByteArrayInputStream result = importSchemaService.serializeImportSchema(schemaList);
