package fr.gouv.vitamui.referential.external.server.service.ingestcontract;
...
public class IngestContractCSVUtils extends ImportCSVUtils {
    ...
    private static List<ColumnDetails> buildIngestContractColumns(boolean isIdentifierMandatory) {
        ...
        expectedColumns.add(
            ColumnDetails.builder()
                .index(5)
                .columnName(CHECK_PARENT_LINK)
                .columnType(ColumnType.CHECK_PARENT_LINK_TYPE)
                .mandatory(false)
                .build()
        );
        expectedColumns.add(
        ...
        expectedColumns.add(
            ColumnDetails.builder()
                .index(8)
                .columnName(FORMAT_UNIDENTIFIED_AUTHORIZED)
        ...
        expectedColumns.add(
            ColumnDetails.builder()
                .index(11)
                .columnName(MANAGEMENT_CONTRACT_ID)
                .columnType(ColumnType.STRING)
                .mandatory(false)
                .build()
        );
        expectedColumns.add(
            ColumnDetails.builder()
                .index(12)
                .columnName(COMPUTED_INHERITED_RULES_AT_INGEST)
                .columnType(ColumnType.A_BOOLEAN)
                .mandatory(false)
                .build()
        );
