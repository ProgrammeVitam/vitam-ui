...
public final class InternalSubrogationServiceTest {
    ...
    public void testCreateSubrogation() {
        ...
        Mockito.when(userRepository.findByEmailAndCustomerId(USER2_EMAIL, USER2_CUSTOMER_ID)).thenReturn(user2);
        Mockito.when(userRepository.findByEmailAndCustomerId(USER1_EMAIL, USER1_CUSTOMER_ID)).thenReturn(user1);
