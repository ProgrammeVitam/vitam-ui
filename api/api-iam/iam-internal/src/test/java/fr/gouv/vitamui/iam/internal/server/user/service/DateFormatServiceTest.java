...
class DateFormatServiceTest {
    ...
    private static Stream<Arguments> dateParameters() {
        return Stream.of(Arguments.of("2023-06-13T13:11:36.418", "13/06/2023"), Arguments.of("2023-06", null), Arguments.of(null, null));
    }

    private static Stream<Arguments> timeParameters() {
        return Stream.of(Arguments.of("2023-06-13T13:11:36.418", "13:11:36"), Arguments.of("2023-06", null), Arguments.of(null, null));
    }
}
