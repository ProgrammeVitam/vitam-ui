...
public final class CustomerCrudControllerTest {
    ...
    public void testGetPaginatedValues() throws Exception {
        ...
        final PaginatedValuesDto<CustomerDto> result = controller.getAllPaginated(
            Integer.valueOf(0),
            Integer.valueOf(5),
            Optional.empty(),
            Optional.empty(),
    ...
    @Test
    public void testCreationFailsAsTheDomainMailIsAlreadyUsed()
        throws InvalidParseOperationException, PreconditionFailedException {
        final CustomerDto customerDto = buildFullCustomerDto();
        customerDto.setId(null);
        ...
        try {
            ...
            assertEquals(
                ...
                customerDto.getName() +
                ": a customer has already the email domain " +
