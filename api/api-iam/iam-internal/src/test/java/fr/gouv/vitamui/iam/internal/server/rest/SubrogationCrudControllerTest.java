...
public final class SubrogationCrudControllerTest extends AbstractCrudControllerTest<SubrogationDto, Owner> {
    ...
    protected void prepareServices() {
        ...
        Mockito.when(userRepository.findByEmailAndCustomerId(SURROGATE_EMAIL, SURROGATE_CUSTOMER_ID))
            .thenReturn(SURROGATE);
        Mockito.when(userRepository.findByEmailAndCustomerId(SUPER_USER_EMAIL, SUPER_USER_CUSTOMER_ID))
