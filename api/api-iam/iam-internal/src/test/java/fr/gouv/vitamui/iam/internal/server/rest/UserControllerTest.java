...
public final class UserControllerTest implements InternalCrudControllerTest {
    ...
    public void testCreationFailsAsEmailAlreadyExistsForSameCustomer() throws InvalidParseOperationException,
        ...
        prepareServices();
        when(userRepository.findByEmailAndCustomerId(any(), Mockito.eq(userDto.getCustomerId()))).thenReturn(
            buildUser());
    ...
    public void testUpdateFailsAsTheEmailAlreadyExists()
        ...
        prepareServices();
        when(userRepository.findByEmailAndCustomerId(userDto.getEmail(), userDto.getCustomerId())).thenReturn(
            buildUser());
