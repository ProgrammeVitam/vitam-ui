...
public final class IamServerUtilsTest {
    ...
    public static final List<Role> ROLES = Arrays.asList(new Role(ServicesData.ROLE_CREATE_USERS), new Role(ServicesData.ROLE_GET_USERS));
    ...
    public static User buildUser(final String id, final String email, final String groupId, final String customerId, final String level) {
    ...
    public static UserDto buildUserDto(final String id, final String email, final String groupId, final String customerId) {
    ...
    public static Profile buildProfile(final String id, final String identifier, final String name, final String customerId, final Integer tenantId,
    ...
    public static ProfileDto buildProfileDto(final String id, final String name, final String customerId, final Integer tenantId,
            final String applicationName) {
    ...
    public static Group buildGroup(final String id, final String identifier, final String name, final String customerId, final String level) {
    ...
    public static GroupDto buildGroupDto(final String id, final String name, final String customerId, final List<String> profileIds) {
    ...
    public static Customer buildCustomer(final String id, final String name, final String code, final List<String> emailDomains) {
    ...
    public static Tenant buildTenant(final String id, final String name, final Integer tenantIdentifier, final String customerId) {
