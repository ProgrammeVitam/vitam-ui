...
import fr.gouv.vitamui.iam.external.server.group.dto.LinkedProfileExportSheet;
import fr.gouv.vitamui.iam.external.server.group.dto.ProfileGroupExport;
import fr.gouv.vitamui.iam.external.server.group.dto.ProfileGroupExportSheet;
...
public class GroupExportService {
    ...
    private Map<String, String> mapIdApplicationToNames(List<String> idApplications) {
        return this.applicationService.findApplicationByIdentifier(idApplications);
    }
