...
public class GroupInternalServiceTest {
    ...
    public void testGetPaginatedValues() {
        ...
        final PaginatedValuesDto<GroupDto> result = groupService.getAllPaginated(
            Integer.valueOf(0),
            Integer.valueOf(5),
            Optional.empty(),
            Optional.empty(),
    ...
    public void testProcessPatch() {
        ...
        groupService.processPatch(entity, partialDto);
    ...
    public void testProcessPatchStatus() {
        ...
        groupService.processPatch(group, partialDto);
    ...
    public void testBeforePatchSuccess() {
        ...
        when(externalSecurityService.isLevelAllowed(any())).thenCallRealMethod();
        when(externalSecurityService.getLevel()).thenReturn("DSI");
        when(externalSecurityService.getCustomerId()).thenReturn(buildCustomerDto().getId());
    ...
    public void testInternalConvertFromEntityToDto() {
        ...
        final GroupDto groupDto = groupService.getOne(
            group.getId(),
            Optional.empty(),
    ...
    public void getLevels_whenProfilesExist_returnsLevels() {
        ...
        List<String> levels = groupService.getLevels(criteria);
    ...
    public void checkUnitsExist_whenGroupIsCreated_thenCheckAllUnits() {
        ...
        groupService.checkUnitsExist(null, newUnits, "customerId", "");
    ...
    public void checkUnitsExist_whenGroupIsPatched_thenCheckOnlyNewUnits() {
        ...
        groupService.checkUnitsExist(oldUnits, newUnits, "customerId", "");
