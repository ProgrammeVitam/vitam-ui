...
class OperationParserTest {
    ...
    private static Stream<Arguments> parseOldValuesParameters() {
        return Stream.of(
            Arguments.of(
                "{\"diff\":{\"-Otp\":\"oui\",\"+Otp\":\"non\"},\"Date d'opération\":\"2023-05-26T12:53:04.273\"}",
                "Otp:oui"
            ),
            Arguments.of(
                ...
                "Nom:,Email:,Nom de la rue:,Code postal:,Ville:,Pays:,Numéro mobile:,Numéro fixe:,Statut:inactif,Date de suppression:,Groupe de profils:135,Prénom:,Code du site:,Code interne:"
            ),
            Arguments.of("{\"Langue\":\"FRENCH\",\"Date d'opération\":\"2023-03-31T15:31:26.892\"}", "")
        );
    }
