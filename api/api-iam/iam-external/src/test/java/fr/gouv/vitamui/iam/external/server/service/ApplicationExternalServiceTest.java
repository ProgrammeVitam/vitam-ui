...
public class ApplicationExternalServiceTest {
    ...
    private final ApplicationInternalRestClient applicationInternalRestClient = Mockito.mock(
        ApplicationInternalRestClient.class
    );
    ...
    @Before
    public void before() {
        applicationExternalService = new ApplicationExternalService(
    ...
    private void mockSecurityContext(
        ...
        Mockito.when(externalSecurityService.getHttpContext()).thenReturn(
            new ExternalHttpContext(10, "userToken", "applicationid", "identifier")
        );
    }
}
