...
public final class ProfileCrudControllerTest extends AbstractMongoTests implements ExternalCrudControllerTest {
    ...
    public void setup() throws Exception {
        ...
        controller = new ProfileController(profileService, externalSecurityService);
    ...
    private void prepareServices() {
        ...
        when(externalSecurityService.getUser()).thenReturn(buildAuthUserDto());
        when(externalSecurityService.getLevel()).thenReturn(buildAuthUserDto().getLevel());
        when(externalSecurityService.getCustomerId()).thenReturn(buildAuthUserDto().getCustomerId());
        when(externalSecurityService.isLevelAllowed(any())).thenReturn(true);
        when(externalSecurityService.getTenantIdentifier()).thenReturn(profileDto.getTenantIdentifier());
    ...
    public void testCreationFailsAsTheNameAlreadyExists()
        ...
        Assertions.assertEquals(externalSecurityService.getCustomerId(), "customerId");
