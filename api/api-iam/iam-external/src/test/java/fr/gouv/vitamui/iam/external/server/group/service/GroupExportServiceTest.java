package fr.gouv.vitamui.iam.external.server.group.service;

import fr.gouv.vitamui.commons.api.domain.GroupDto;
import fr.gouv.vitamui.commons.api.domain.ProfileDto;
import fr.gouv.vitamui.iam.external.server.application.service.ApplicationService;
import fr.gouv.vitamui.iam.external.server.group.dto.LinkedProfileExport;
import fr.gouv.vitamui.iam.external.server.group.dto.ProfileGroupExport;
...
import static fr.gouv.vitamui.iam.external.server.group.dto.LinkedProfileExportSheet.LINKED_PROFILE_SHEET_COLUMNS;
import static fr.gouv.vitamui.iam.external.server.group.dto.LinkedProfileExportSheet.LINKED_PROFILE_SHEET_NAME;
import static fr.gouv.vitamui.iam.external.server.group.dto.ProfileGroupExportSheet.PROFILE_GROUP_SHEET_COLUMNS;
import static fr.gouv.vitamui.iam.external.server.group.dto.ProfileGroupExportSheet.PROFILE_GROUP_SHEET_NAME;
import static fr.gouv.vitamui.iam.external.server.utils.IamServerUtilsTest.buildGroupDto;
import static fr.gouv.vitamui.iam.external.server.utils.IamServerUtilsTest.buildProfileDto;
...
class GroupExportServiceTest {
    ...
    private GroupExportService groupExportService = new GroupExportService(applicationService);
    ...
    void testExportProfileGroups_second_sheet_OK() throws IOException {
        ...
        // When
        when(applicationService.findApplicationByIdentifier(List.of("ARCHIVE_APP"))).thenReturn(
