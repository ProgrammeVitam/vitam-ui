package fr.gouv.vitamui.iam.external.server.application.service;
...
import fr.gouv.vitamui.iam.external.server.application.converter.ApplicationConverter;
import fr.gouv.vitamui.iam.external.server.application.dao.ApplicationRepository;
...
public class ApplicationServiceTest {
    ...
    public void testGetAllForNullUserThenThrowException() {
        ...
        Mockito.when(externalSecurityService.getUser()).thenReturn(null);
