...
/**
 * The shape of the authentication attributes IAM sends to the authentication server.
 *
 * The response keeps the types the token needs: scalars stay typed, the two enums travel as their name (what they
 * serialize to) and the composite attributes travel as their already-serialized JSON. This is what lets the
 * authentication server rebuild the very same principal without depending on the administration model.
 */
