 ...
 * Emmanuel Deviller
 */
public final class UserControllerTest implements ExternalCrudControllerTest {
    ...
    public void setup() {
        ...
        userController = new UserController(userService, connectionHistoryService, externalSecurityService);
    ...
    protected void prepareServices() {
        ...
        when(externalSecurityService.isLevelAllowed(anyString())).thenCallRealMethod();
    ...
    public void testPatchAnalyticsOk() throws InvalidParseOperationException {
        ...
        userController = new UserController(userService1, connectionHistoryService, externalSecurityService);
