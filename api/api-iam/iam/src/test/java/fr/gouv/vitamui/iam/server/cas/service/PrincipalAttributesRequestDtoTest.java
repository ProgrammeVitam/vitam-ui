...
/**
 * The request sent by the authentication server may omit {@code apiContext} (a primitive boolean). With the same
 * Jackson as the IAM controller, deserialization must default it to false instead of failing.
 */
