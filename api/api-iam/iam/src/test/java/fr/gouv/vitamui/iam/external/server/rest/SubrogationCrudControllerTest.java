...
/**
 * Tests the {@link SubrogationController}.
 */
...
public final class SubrogationCrudControllerTest extends AbstractCrudControllerTest<SubrogationDto, Owner> {
    ...
    @InjectMocks
    private SubrogationController controller;
    ...
    public void setup() {
        ...
        final SubrogationService service = new SubrogationService(
        ...
        controller = new SubrogationController(service);
    }
    ...
    public void testCreationOK() throws InvalidParseOperationException, PreconditionFailedException {
        ...
        when(externalSecurityService.getUser()).thenReturn(
