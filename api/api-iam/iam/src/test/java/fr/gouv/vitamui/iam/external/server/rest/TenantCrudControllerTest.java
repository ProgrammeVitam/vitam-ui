 ...
 */
public final class TenantCrudControllerTest implements ExternalCrudControllerTest {
    ...
    public void testCreationOK() throws Exception {
        ...
        Mockito.when(externalSecurityService.getTenant(ArgumentMatchers.any())).thenReturn(dto);
        prepareServices();
