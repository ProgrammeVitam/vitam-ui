...
public final class LoginPwdAuthenticationHandlerTest {
    ...
    public void testNoUser() {
        ...
        // The IAM login now returns an ENABLED, NOMINATIVE user or throws; an unknown user is a
        // NotFoundException, which the handler maps to a PreventedException. (It no longer returns null.)
    ...
    public void testUserDisabled() {
        ...
        // A user whose status the IAM refuses (e.g. DISABLED) surfaces as an InvalidFormatException; the
        // handler no longer re-checks the status itself, it maps that exception to an AccountDisabledException.
