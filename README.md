...
3. Integrate generated certs into Vitamui database.

After generating PKI, we should integrate the generated certificates into the database, this action is done by following
theses steps:
a. Stop and clean Vitamui mongo dev:
