...
dbIam.providers.updateOne(
    { "_id": "5c7928337884583d1ebb6ebd3b672beb39d04beda4c55d70d5352184d926ed31" },
    {
        $addToSet: {
            "patterns": {
                $each: [
                    ".*@{{ vitamui_platform_informations.default_email_domain }}"
                ]
            }
        }
    }
