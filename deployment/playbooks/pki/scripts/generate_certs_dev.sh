...
REPERTOIRE_CERTIFICAT="${REPERTOIRE_ROOT}/playbooks/pki/dev/certs"
REPERTOIRE_VITAM_CERTIFICAT="${REPERTOIRE_ROOT}/playbooks/pki/dev/vitam/client-external"
...
generateCertificate         cas-server                          dev.vitamui.com                                 jkspasswd           carootkeypassword
generateCertificate         ui-portal                           dev.vitamui.com                                 jkspasswd           carootkeypassword
generateCertificate         ui-identity                         dev.vitamui.com                                 jkspasswd           carootkeypassword
generateCertificate         iam-external                        dev.vitamui.com                                 jkspasswd           carootkeypassword
generateCertificate         iam-internal                        dev.vitamui.com                                 jkspasswd           carootkeypassword
generateCertificate         security-internal                   dev.vitamui.com                                 jkspasswd           carootkeypassword
generateCertificate         nginx                               *.vitamui.com                                   jkspasswd           carootkeypassword

pki_logger "Génération des certificats pour VITAM"
generateCertificateVitam    vitamui-vitam-external                         jkspasswd                          carootkeypassword
generateCertificateVitam    vitamui-vitam-reverse                          jkspasswd                          carootkeypassword
generateCertificateVitam    vitamui-client-example                         jkspasswd                          carootkeypassword
