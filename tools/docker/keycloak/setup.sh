...
# logout webflow, where DelegatedSaml2ClientFinishLogoutAction (cas-server-support-pac4j-saml)
# picks the client back up from the SAML RelayState. Sent to the login callback instead, it is
# taken for an authentication attempt and answered with the "unauthorized" page.
