    ...
    stages {
        ...
        stage('Check vulnerabilities and tests') {
            ...
            steps {
                ...
                sh '''
                    $MVN_COMMAND clean verify -U -Pvitam -pl '!cots/vitamui-mongod,!cots/vitamui-logstash,!cots/vitamui-mongo-express'
                '''
            }
            post {
                always {
        ...
        stage('Build sources') {
            ...
            steps {
                sh 'npmrc default'
                sh '''
                    $MVN_COMMAND deploy -Pvitam,deb,rpm -DskipTests -DskipAllFrontend=true -DskipAllFrontendTests=true -Dlicense.skip=true -pl '!cots/vitamui-mongod,!cots/vitamui-logstash,!cots/vitamui-mongo-express'
                '''
            }
        }
