...
//                '''
                sh '''
                    $MVN_COMMAND clean verify -Pvitam -pl '!cots/vitamui-nginx,!cots/vitamui-mongod,!cots/vitamui-logstash,!cots/vitamui-mongo-express' -DskipTests -DskipAllFrontend  $JAVA_TOOL_OPTIONS
                '''
            }
            post {
                always {
