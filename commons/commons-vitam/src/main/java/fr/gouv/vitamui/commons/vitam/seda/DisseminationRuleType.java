 ...
 *
 * <p>Classe Java pour DisseminationRuleType complex type.
 *
...
@XmlType(name = "DisseminationRuleType", propOrder = { "ruleAndStartDate", "preventInheritance", "refNonRuleId" })
public class DisseminationRuleType {
