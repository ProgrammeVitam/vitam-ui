...
@XmlType(name = "BusinessMessageType", propOrder = { "archivalAgreement", "codeListVersions", "dataObjectPackage" })
@XmlSeeAlso({ BusinessRequestMessageType.class, BusinessReplyMessageType.class, BusinessNotificationMessageType.class })
