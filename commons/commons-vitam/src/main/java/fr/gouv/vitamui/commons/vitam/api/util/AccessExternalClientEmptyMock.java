...
public class AccessExternalClientEmptyMock extends AbstractMockClient implements AccessExternalClient {
    ...
    public RequestResponse<LogbookOperation> selectOperations(VitamContext vitamContext, JsonNode select) {
        return (new RequestResponseOK<LogbookOperation>()).addAllResults(new ArrayList<>())
    ...
    @Override
    public RequestResponse<JsonNode> selectUnitsByUnitPersistentIdentifier(VitamContext vitamContext, JsonNode jsonNode,
        String s)
    ...
    public RequestResponse<LogbookOperation> selectOperationbyId(VitamContext vitamContext, String processId,
        JsonNode select) {
        throw new NotImplementedException("");
    }
    ...
    public RequestResponse<LogbookLifecycle> selectObjectGroupLifeCycleById(VitamContext vitamContext, String idObject,
        JsonNode select) {
        throw new NotImplementedException("");
    }
    ...
    @Override
    public RequestResponse<JsonNode> getObjectByObjectPersistentIdentifier(VitamContext vitamContext, JsonNode jsonNode,
        String s) throws VitamClientException {
        throw new NotImplementedException("");
    }
