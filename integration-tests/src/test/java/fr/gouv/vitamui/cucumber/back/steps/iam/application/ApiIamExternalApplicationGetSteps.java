...
public class ApiIamExternalApplicationGetSteps extends CommonSteps {
    ...
    @When(
        "^un utilisateur récupère toutes les applications dans un tenant auquel il est autorisé en utilisant un certificat full access$"
    )
    ...
    @When(
        "^un utilisateur récupère toutes les applications dans un tenant auquel il est autorisé avec un accès limité aux applications$"
    )
    ...
    @When(
        "^un utilisateur récupère toutes les applications dans un tenant auquel il est autorisé sans filtre sur les applications"
    )
