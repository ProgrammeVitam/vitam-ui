...
public class ApiIamExternalCasLoginSteps extends CommonSteps {
    ...
    public void l_utilisateur_est_bloqué() {
        ...
        final List<UserDto> basicUsersDto = getCasRestClient(false, new Integer[] {casTenantIdentifier},
            new String[] {ServicesData.ROLE_CAS_USERS}).getUsersByEmail(context, testContext.authUserDto.getEmail(), Optional.empty());
        assertThat(basicUsersDto.size()).isEqualTo(1);
