...
public class ApiIamExternalIdentityPoviderCreationSteps extends CommonSteps {
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_CREATE_PROVIDERS ajoute un nouveau provider dans un tenant auquel il est autorisé en utilisant un certificat full access avec le rôle ROLE_CREATE_PROVIDERS$"
    )
