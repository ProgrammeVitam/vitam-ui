...
import fr.gouv.vitamui.archives.search.client.ArchiveSearchExternalRestClientFactory;
import fr.gouv.vitamui.archives.search.client.SearchCriteriaHistoryExternalRestClient;
