...
public class ApiIamExternalCasChangePasswordSteps extends CommonSteps {
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_CAS_CHANGE_PASSWORD change le mot de passe d'un utilisateur dans un tenant auquel il est autorisé en utilisant un certificat sur le tenant et avec le rôle ROLE_CAS_CHANGE_PASSWORD$"
    )
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_CAS_CHANGE_PASSWORD change le mot de passe d'un utilisateur générique dans un tenant auquel il est autorisé en utilisant un certificat sur le tenant et avec le rôle ROLE_CAS_CHANGE_PASSWORD$"
    )
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_CAS_CHANGE_PASSWORD change le mot de passe d'un utilisateur désactivé dans un tenant auquel il est autorisé en utilisant un certificat sur le tenant et avec le rôle ROLE_CAS_CHANGE_PASSWORD$"
    )
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_CAS_CHANGE_PASSWORD change le mot de passe d'un utilisateur inexistant dans un tenant auquel il est autorisé en utilisant un certificat sur le tenant et avec le rôle ROLE_CAS_CHANGE_PASSWORD$"
    )
