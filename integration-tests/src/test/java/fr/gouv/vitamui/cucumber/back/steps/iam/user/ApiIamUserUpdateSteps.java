...
public class ApiIamUserUpdateSteps extends CommonSteps {
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_UPDATE_USERS met à jour un utilisateur dans un tenant auquel il est autorisé en utilisant un certificat full access avec le rôle ROLE_UPDATE_USERS$"
    )
    public void un_utilisateur_avec_le_rôle_ROLE_UPDATE_USERS_met_à_jour_un_utilisateur_dans_un_tenant_auquel_il_est_autorisé_en_utilisant_un_certificat_full_access_avec_le_rôle_ROLE_UPDATE_USERS() {
        updatedUser = getUserRestClient(true, null, new String[] { ROLE_UPDATE_USERS }).update(
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_UPDATE_USERS met à jour un utilisateur en readonly dans un tenant auquel il est autorisé en utilisant un certificat full access avec le rôle ROLE_UPDATE_USERS$"
    )
    public void un_utilisateur_avec_le_rôle_ROLE_UPDATE_USERS_met_à_jour_un_utilisateur_en_readonly_dans_un_tenant_auquel_il_est_autorisé_en_utilisant_un_certificat_full_access_avec_le_rôle_ROLE_UPDATE_USERS() {
        ...
        try {
            getUserRestClient(true, null, new String[] { ROLE_UPDATE_USERS }).update(
                getSystemTenantUserAdminContext(),
                updatedUser
            );
    ...
    public void le_serveur_refuse_la_mise_à_jour_de_l_utilisateur_à_cause_du_readonly() {
        ...
        assertThat(testContext.exception.toString()).isEqualTo(
            "fr.gouv.vitamui.commons.api.exception.InvalidFormatException: Unable to update user " +
            updatedUser.getId() +
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_UPDATE_USERS met à jour un utilisateur mais avec un mauvais client dans un tenant auquel il est autorisé en utilisant un certificat full access avec le rôle ROLE_UPDATE_USERS$"
    )
    ...
    public void le_serveur_refuse_la_mise_à_jour_de_l_utilisateur_à_cause_du_mauvais_client() {
        assertThat(testContext.exception).isNotNull();
        assertThat(testContext.exception.toString()).isEqualTo(
            "fr.gouv.vitamui.commons.api.exception.InvalidFormatException: Unable to update user: customerId " +
            CLIENT1_CUSTOMER_ID +
            " is not allowed"
        );
    }
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_UPDATE_USERS met à jour un utilisateur mais avec un email existant dans un tenant auquel il est autorisé en utilisant un certificat full access avec le rôle ROLE_UPDATE_USERS$"
    )
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_UPDATE_USERS met à jour un utilisateur mais avec un groupe inexistant dans un tenant auquel il est autorisé en utilisant un certificat full access avec le rôle ROLE_UPDATE_USERS$"
    )
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_UPDATE_USERS sans le bon niveau met à jour un utilisateur dans un tenant auquel il est autorisé en utilisant un certificat full access avec le rôle ROLE_UPDATE_USERS$"
    )
    ...
    @When(
        "^un utilisateur avec le rôle ROLE_UPDATE_USERS active un utilisateur dans un tenant auquel il est autorisé en utilisant un certificat full access avec le rôle ROLE_UPDATE_USERS$"
    )
