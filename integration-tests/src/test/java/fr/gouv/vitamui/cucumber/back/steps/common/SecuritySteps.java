...
public class SecuritySteps extends CommonSteps {
    ...
    public void then_le_serveur_refuse_l_accès_à_l_API_x(final String api) {
        assertThat(testContext.exception)
            .overridingErrorMessage("Le serveur n'a pas refusé l'accès : aucune exception n'a été levée")
            .isNotNull();
        final String message = testContext.exception.toString();
        assertThat(message).isNotNull();
        final boolean isAccessUnauthorized = message.equals(
            "fr.gouv.vitamui.commons.api.exception.ForbiddenException: Accès refusé"
        );
        final boolean isInvalidAuthentication = message.equals(
            "fr.gouv.vitamui.commons.api.exception.InvalidAuthenticationException: Full authentication is required to access this resource"
        );
        final boolean isForbiddenException = message.equals(
            "fr.gouv.vitamui.commons.api.exception.ForbiddenException: Unknown problem"
        );
        final boolean isAccessDenied = message.equals(
            "fr.gouv.vitamui.commons.api.exception.ForbiddenException: Access is denied"
        );
        final boolean isInvalidAuthentication2 = message.equals(
            "fr.gouv.vitamui.commons.api.exception.InvalidAuthenticationException: Unknown problem"
        );
        assertThat(
            isAccessUnauthorized ||
            isInvalidAuthentication ||
            isForbiddenException ||
            isAccessDenied ||
            isInvalidAuthentication2
        )
            .overridingErrorMessage(
                "Le serveur a bien refusé l'accès, mais pour une raison inattendue. Le message d'erreur obtenu est le suivant : " +
                message
            )
            .isTrue();
    }
    ...
    public void le_serveur_ne_retourne_pas_d_erreur() throws Exception {
        assertThat(testContext.exception)
            .overridingErrorMessage("Le serveur a renvoyé l'erreur suivante : " + testContext.exception)
            .isNull();
    }
    ...
    protected void headNotSupported() {
        ...
        final String message = testContext.exception.toString();
        assertThat(message).isNotNull();
        final boolean internalServerException = message.equals(
            "fr.gouv.vitamui.commons.api.exception.InternalServerException: Unknown problem"
        );
        final boolean notImplementedException = message.equals(
            "fr.gouv.vitamui.commons.api.exception.NotImplementedException: Unknown problem"
        );
    ...
    protected void updateNotSupported() {
        ...
        final String message = testContext.exception.toString();
        assertThat(message).isNotNull();
        final boolean invalidFormatException = message.equals(
            "fr.gouv.vitamui.commons.api.exception.InvalidFormatException: Invalid Request : Request method 'PUT' not supported."
        );
        final boolean notImplementedException = message.equals(
            "fr.gouv.vitamui.commons.api.exception.NotImplementedException: Update not supported"
        );
    ...
    protected void deleteNotSupported() {
        ...
        assertThat(testContext.exception.toString()).isEqualTo(
            "fr.gouv.vitamui.commons.api.exception.InvalidFormatException: Invalid Request : Request method 'DELETE' not supported."
        );
    }
    ...
    protected void getNotSupported() {
        assertThat(testContext.exception)
            ...
            .isNotNull();
        assertThat(testContext.exception.toString()).isEqualTo(
            "fr.gouv.vitamui.commons.api.exception.InvalidFormatException: Invalid Request : Request method 'GET' not supported."
        );
    }
    ...
    public void then_le_serveur_refuse_l_accès_pour_cause_de_niveau_non_autorise() {
        ...
        final String message = testContext.exception.toString();
        assertThat(message).isNotNull();
        final boolean isInvalidFormatException = message.matches(
            "fr.gouv.vitamui.commons.api.exception.InvalidFormatException: Unable to create (.+): level (.*) is not allowed"
        );
        assertThat(isInvalidFormatException)
            .overridingErrorMessage(
                "Le serveur a bien refusé l'accès, mais pour une raison inattendue. Le message d'erreur obtenu est le suivant : " +
                message
            )
    ...
    public void then_le_serveur_refuse_l_accès_pour_cause_de_groupe_non_trouvé() {
        ...
        assertThat(message).isNotNull();
        final boolean isInvalidFormatException = message.matches(
            "fr.gouv.vitamui.commons.api.exception.InvalidFormatException: Unable to create user (.+): group does not exist"
        );
        ...
        assertThat(isInvalidFormatException || isINotFoundException)
            .overridingErrorMessage(
                "Le serveur a bien refusé l'accès, mais pour une raison inattendue. Le message d'erreur obtenu est le suivant : " +
                message
            )
    ...
    public void un_utilisateur_avec_le_rôle_ROLE_sur_le_tenant_x(
        final RoleParameterType role,
        final TenantParameterType tenant
    ) throws Exception {
    ...
    public void un_utilisateur_avec_les_rôles_ROLE_sur_le_tenant_x(
        final RolesParameterType roles,
        final TenantParameterType tenant
    ) throws Exception {
    ...
    public void un_utilisateur_sans_le_rôle_ROLE_sur_ce_tenant(
        final RoleParameterType role,
        final TenantParameterType tenant
    ) throws Exception {
    ...
    public void un_utilisateur_sans_les_rôles_ROLE_sur_ce_tenant(
        final RolesParameterType roles,
        final TenantParameterType tenant
    ) throws Exception {
        testContext.tokenUser = tokenUserNoRole(tenant.getTenant(testContext));
    ...
    public void un_certificat_avec_le_rôle_ROLE_sur_le_même_tenant(
        final RoleParameterType role,
        final TenantParameterType tenant
    ) throws Exception {
    ...
    public void un_certificat_avec_les_rôles_ROLE_sur_le_même_tenant(
        final RolesParameterType roles,
        final TenantParameterType tenant
    ) throws Exception {
    ...
    public void un_certificat_sans_le_rôle_ROLE_FLOWS_sur_le_même_tenant(
        final RoleParameterType role,
        final TenantParameterType tenant
    ) throws Exception {
    ...
    public void un_certificat_sans_les_rôles_ROLE_FLOWS_sur_le_même_tenant(
        final RolesParameterType roles,
        final TenantParameterType tenant
    ) throws Exception {
        setCertificateContext(false, tenant.getTenant(testContext), testContext.defaultRole);
